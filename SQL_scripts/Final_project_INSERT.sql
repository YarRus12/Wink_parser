...
VALUES
  ...
  ('4', 'Аль Пачино', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('5', 'Стивен Бауэр', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('6', 'Мишель Пфайффер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('7', 'Сисси Спейсек', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('8', 'Пайпер Лори', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('9', 'Эми Ирвинг', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('10', 'Кевин Костнер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('11', 'Шон Коннери', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('12', 'Чарльз Мартин Смит', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('13', 'Шон Пенн', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('14', 'Пенелопа Энн Миллер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('15', 'Ребекка Ромейн', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('16', 'Антонио Бандерас', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('17', 'Питер Койот', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('18', 'Джон Литгоу', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('19', 'Лолита Давидович', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('20', 'Стивен Бауэр', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('21', 'Гэри Синиз', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('22', 'Тим Роббинс', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('23', 'Дон Чидл', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('24', 'Марлон Брандо', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('25', 'Джеймс Каан', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('26', 'Мартин Шин', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('27', 'Роберт Дювалл', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('28', 'Джонни Депп', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('29', 'Кристина Риччи', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('30', 'Миранда Ричардсон', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('31', 'Донатас Банионис', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('32', 'Наталья Бондарчук', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('33', 'Юри Ярвет', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('34', 'Анатолий Солоницын', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('35', 'Иван Лапиков', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('36', 'Николай Гринько', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('37', 'Александр Кайдановский', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('38', 'Джек Николсон', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('39', 'Шелли Дювалл', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('40', 'Дэнни Ллойд', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('41', 'Мэттью Модайн', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('42', 'Адам Болдуин', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('43', 'Винсент Д’Онофрио', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('44', 'Кир Дуллеа', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('45', 'Гэри Локвуд', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('46', 'Уильям Сильвестр', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('47', 'Николь Кидман', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('48', 'Сидни Поллак', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('49', 'Леонардо ДиКаприо', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('50', 'Джона Хилл', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('51', 'Марго Робби', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('52', 'Марк Руффало', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('53', 'Бен Кингсли', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('54', 'Мэтт Дэймон', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('55', 'Роберт Де Ниро', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('56', 'Рэй Лиотта', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('57', 'Джо Пеши', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('58', 'Джон Траволта', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('59', 'Сэмюэл Л. Джексон', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('60', 'Брюс Уиллис', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('61', 'Брэд Питт', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('62', 'Джейми Фокс', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('63', 'Кристоф Вальц', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('64', 'Курт Рассел', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('65', 'Тим Рот', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('66', 'Мэттью МакКонахи', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('67', 'Чарли Ханнэм', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('68', 'Генри Голдинг', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('69', 'Джейсон Стэйтем', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('70', 'Холт Маккэллани', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('71', 'Джеффри Донован', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('72', 'Джейсон Флеминг', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('73', 'Декстер Флетчер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('74', 'Стивен Грэм', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('75', 'Адам Драйвер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('76', 'Джоди Комер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('77', 'Рассел Кроу', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('78', 'Хоакин Феникс', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('79', 'Конни Нильсен', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('80', 'Сигурни Уивер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('81', 'Том Скеррит', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('82', 'Иэн Холм', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('83', 'Нуми Рапас', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('84', 'Майкл Фассбендер', STR_TO_DATE('____-__-__', '%Y-%m-%d')),
  ('85', 'Шарлиз Терон', STR_TO_DATE('____-__-__', '%Y-%m-%d'))
  ;
