...
VALUES
  ('1', 'Meredith','Parks',STR_TO_DATE('1962-07-03', '%Y-%m-%d'),'parks-meredith8064@google.com', STR_TO_DATE('2022-07-03', '%Y-%m-%d')),
  ('2', 'Jolie','Middleton',STR_TO_DATE('1963-06-03', '%Y-%m-%d'),'j_middleton9079@google.com', STR_TO_DATE('2023-07-03', '%Y-%m-%d')),
  ('3', 'Ginger','Stout',STR_TO_DATE('1966-07-21', '%Y-%m-%d'),'stout_ginger@google.com', STR_TO_DATE('9999-12-31', '%Y-%m-%d')),
  ('4', 'Charles','Roberts',STR_TO_DATE('1993-07-23', '%Y-%m-%d'),'c_roberts1636@google.com', STR_TO_DATE('9999-12-31', '%Y-%m-%d')),
  ('5','Pearl','Ramsey',STR_TO_DATE('1982-12-08', '%Y-%m-%d'),'ramseypearl2602@google.com', STR_TO_DATE('2022-12-31', '%Y-%m-%d')),
  ('6', 'Lana','Lopez',STR_TO_DATE('1952-11-11', '%Y-%m-%d'),'llopez4080@google.com', STR_TO_DATE('9999-12-31', '%Y-%m-%d')),
  ('7', 'Jorna','Richard',STR_TO_DATE('1982-12-06', '%Y-%m-%d'),'Jorra421110@google.com', STR_TO_DATE('9999-12-31', '%Y-%m-%d')),
  ('8', 'Jack','Lores',STR_TO_DATE('1992-05-01', '%Y-%m-%d'),'loga223@google.com', STR_TO_DATE('9999-12-31', '%Y-%m-%d'));
...
-- Клиент с id 2 купил подписку full
UPDATE clients
